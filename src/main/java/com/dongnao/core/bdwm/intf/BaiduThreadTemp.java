...
@Service("baiduThreadTemp")
public class BaiduThreadTemp implements IScheduleTaskDealMulti<String> {
    ...
    private static transient Logger log = LoggerFactory.getLogger(BaiduThreadTemp.class);
